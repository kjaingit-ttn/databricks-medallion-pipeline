# Databricks notebook cell: Silver completeness quality check
#
...
# Local development / git repo source of truth: src/silver/01_quality_completeness.py
...
def run_completeness_checks() -> dict:
...
def verify_expected_failures(reports: dict) -> None:
...
reports = run_completeness_checks()
