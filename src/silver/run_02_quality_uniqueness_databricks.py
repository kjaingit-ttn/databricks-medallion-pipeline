# Databricks notebook cell: Silver uniqueness quality check
#
# FULLY SELF-CONTAINED — paste this entire file into one Databricks notebook cell.
# No runpy, no imports from sibling repo files, no __file__.
# Local development / git repo source of truth: src/silver/02_quality_uniqueness.py
...
def uniqueness_report(df: DataFrame, key_column: str, label: str) -> dict:
...
def verify_expected_duplicates(reports: dict) -> None:
...
def run_uniqueness_checks() -> dict:
